...
class Star(Body):
    ...
    def __init__(self, position:smaths.Point, colour:graphdefs.Colour3, scale:float, index:int, name:str, parent_galaxy:Galaxy, possible_colours=[graphdefs.Colour3(247, 109, 22),graphdefs.Colour3(242, 196, 80),graphdefs.Colour3(130, 176, 255)]):
